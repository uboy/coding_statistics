...
class GitHubSource(BaseSource):
    ...
    def _request(self, path: str, params: dict | None = None) -> Any:
        ...
        logger.debug(
            "GitHub API request: %s | headers: %s | params: %s",
            url,
        ...
        try:
            ...
            logger.debug("GitHub API response: %s %s", resp.status_code, resp.reason)
            ...
            if hasattr(exc, "response") and exc.response is not None:
                try:
                    ...
                    pass
            logger.error(
                "GitHub API error for %s | params: %s | error: %s | response: %s",
                url,
                params or {},
                exc,
                response_text,
